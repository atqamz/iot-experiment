...
void dimmerLamp::timer_init(void)
{
    ...
    // New implementation for ESP32 Core v3.x
    // Timer frequency is 320kHz, same as the old implementation (80MHz / 250)
    timer = timerBegin(320000);
    // Attach onTimer function to our timer.
    timerAttachInterrupt(timer, &onTimerISR);
    // Set alarm to call onTimer function. 30 is the alarm value.
    // The third parameter is auto-reload.
